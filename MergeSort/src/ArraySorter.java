 ...
 * now includes merge sort !!!
 * major key to sorting arrays fast
 * @author Ned Ellis (and barb ericson)
 */
...
public class ArraySorter
{
    ...
    {
        /**
         * Create three indexes to keep place inside arrays
         */
        ...
        /**
         * Conditional to ensure that neither the right or left array has run out of numbers
         * Then decides which number is higher
         * Then increases the count of aIndex and the array index used
         */
        ...
        /**
         * Now writes all unused numbers to the array
         * The key is that only one array will be left at this point
